...
- **Иконку рисует UI, а не модель.** Генеративные модели нестабильно
  ...
  оставлять **центр кадра пустым полем цвета** (`_CLEAR_CENTRE_RADIUS`).
- **Обложка — графический баннер, а не «AI-картинка про математику».** Один
  доминирующий цвет заливкой, 2-4 простых абстрактных элемента из оттенков
  того же цвета, мягкая асимметрия, много воздуха. Никаких почти чёрных
  фонов, крупных центральных символов и случайных объектов.

...
- **Свет тусклый и широкий, а не прожектор.** `never a bright spotlight`,
  ...
  and calm`. В первой версии модель ставила в середину яркое пятно, и обложка
  выглядела как фонарик в темноте; в локальном рендере то же лечится шире
  радиусом и слабее альфой ореола.

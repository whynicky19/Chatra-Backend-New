...
async def ai_chat(
    ...
    if server_lecture_context:
        payload["messages"].insert(0, {
            "role": "system",
            "content": (
                "Материалы класса, найденные поиском по вопросу пользователя "
                "(отвечай опираясь на них — это не все материалы класса, а "
        ...
        payload["messages"].insert(0, {"role": "system", "content": (
            f"У этого класса нет лекции №{requested_lecture_number} (или её "
        ...
        payload["messages"].insert(0, {"role": "system", "content": (
            "В материалах класса не нашлось ничего по этому вопросу (либо "
